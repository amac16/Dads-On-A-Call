...
Double-click **Start Dad's On Call.cmd**. It builds the app on the first run using the .NET Framework compiler included with Windows. You can also run **dist\DadsOnCall.exe** directly once built, or create a Windows shortcut to it.
